...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-03-2025 a las 01:23:38
...
CREATE TABLE `tm_ticket` (
  ...
  `tick_descrip` int(255) NOT NULL,
  `tick_estado` varchar(50) NOT NULL,
  `fech_crea` datetime NOT NULL,
  `usu_asig` int(11) DEFAULT NULL,
  `fech_asig` datetime DEFAULT NULL,
  `prio_id` int(11) NOT NULL,
  `est` int(11) NOT NULL,
  `tick_coment` varchar(255) DEFAULT NULL,
...
INSERT INTO `tm_usuario` (`usu_id`, `usu_nom`, `usu_ape`, `usu_pass`, `rol_id`, `fecha_crea`, `fecha_modi`, `fecha_elim`, `estado`, `usu_correo`) VALUES
(1, 'Juan Pablo', 'Castaño', '123', 0, '2025-03-12 01:21:17', NULL, NULL, 1, 'castanocastano6@gmail.com');
